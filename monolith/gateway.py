...
class RealGateway(GatewayInterface):
    ...
    def get_reservation(self, reservation_id):
        return get(f"{self.addr}/bookings/{reservation_id}")

    def delete_reservation(self, reservation_id):
        return delete(f"{self.addr}/bookings/{reservation_id}")

    # TODO
    def register_entrance(self, reservation_id):
        pass
    
    # TODO
    def get_reservations(self, restaurant_id, begin, end):
        pass